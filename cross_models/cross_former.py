...
class Crossformer(nn.Module):
    def __init__(self, data_dim, out_dim, ycat, in_len, out_len, seg_len, win_size = 4, 
        ...
        # Embedding
        self.enc_value_embedding = DSW_embedding(seg_len, d_model, ycat)
